...
public class AirlineBookingSystem {
    ...
    public static void main(String[] args) {
        ...
        // Test code for multiple constructors
        Flight flight2 = new Flight(airline, date, origin, destination);
        flight2.printFlightDetails();
        
        Flight flight3 = new Flight();
        flight3.setAirline("Test Airline");
        flight3.setDate(date);
        flight3.setOrigin("Test Origin");
        flight3.setDestination("Test Destination");
        flight3.setSeats(seats);
    ...
    public static class Flight {
        ...
        public Flight(String airline, Date date, String origin, String destination) {
