...
public class FlightReservationGUI {
    ...
    public FlightReservationGUI() {
        ...
        flightPanel.setForeground(Color.PINK);
        ...
        frame.getContentPane().add(flightPanel, BorderLayout.NORTH);
        frame.getContentPane().add(seatPanel, BorderLayout.CENTER);
        frame.getContentPane().add(pricePanel, BorderLayout.EAST);
        frame.getContentPane().add(clientPanel, BorderLayout.SOUTH);
